...
int main(int argc, char ** argv)
{
  ...
  // save images
  cv::imwrite("/home/M1/Traitement_Images/td-03/output/imageGS.jpg",image);
  cv::imwrite("/home/M1/Traitement_Images/td-03/output/histogram.jpg",histogramToImageGS(computeHistogramGS(image)));
